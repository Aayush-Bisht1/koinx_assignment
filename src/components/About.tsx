...
import calculateProfitImg from "../assets/CalculateProfits.png";
import calculateTaxImg from "../assets/CalculateTaxLiability.png";
          ...
          <div className="lg:flex border-b-2 border-[#C9CFDD]/40 pb-4">
            ...
            <div className="mt-4 lg:ml-8">
              <div className="lg:w-[400px] h-[151px] bg-gradient-to-br from-[#FF9865] to-[#EF3031] rounded-lg flex">
                <div className="p-3">
                  <img
                    className="w-32 h-32 rounded-xl object-center object-cover"
                    src={calculateTaxImg}
                    alt=""
                  />
                </div>
